...
if __name__ == '__main__':
    ...
    for loop_index in range(1):
        for model_name in models:
            ...
            model_load_location = '../saved_models_1a/' + model_name + '/' + str(loop_index) + '/' 
            
            result_save_location = '../saved_test_result_1a/' + model_name + '/' + str(loop_index) + '/'
            
            report_result_save_location = '../saved_test_report_1a/' + model_name + '/' + str(loop_index)
