...
def main(model_load_location):
    ...
    dataset_location = '../Datasets/Subtask_1a/'
...
if __name__ == '__main__':
    ...
    for loop_index in range(n_rounds):
        for model_name in models:
            ...
            result_save_location = '../2nd_try_15_epochs_large_model/saved_test_result_1a/' + model_name + '/' + str(loop_index) + '/'
    ...
    os.makedirs('../2nd_try_15_epochs_large_model/testing_statistics/', exist_ok=True)
    with open('../2nd_try_15_epochs_large_model/testing_statistics/time.txt', 'w') as file:
